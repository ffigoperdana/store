...
export type GptPackage = {
  ...
  variant: { id: string; sku: string; name: string; price: number; compareAtPrice: number | null; channel: string | null; duration: string | null; warranty: string | null; estimatedProcess: string | null; fulfillmentMode: "MANUAL_WHATSAPP" | "SINGLE_SHARED" | "UNIQUE_POOL"; available: boolean };
};
